...
export default function AboutMe() {
  return (
    <div className='layout-width absolute top-28 md:top-56 left-1/2 -translate-x-1/2 w-full flex flex-col sm:flex-row items-center sm:items-start gap-y-5 sm:gap-x-5'>
      <AnimatedImg />
      <motion.section
        initial={{ opacity: 0 }}
